...
excerpt: "프로그래머스 나머지가 1이 되는 수 찾기 문제 풀이"
...
<script src="https://gist.github.com/cmblir/712a1c834f9a3b72fd873eff8ee98a7d.js"></script>

- 주석을 참고하면서 이해를 돕습니다.
---

## 4. 알고리즘 및 해설
1. 반복문을 통해 해당 값이 나누어 나머지가 1이 된다면 해당 값을 출력해준다.