...
excerpt: "프로그래머스 두 개 뽑아서 더하기 문제 풀이"
...
<script src="https://gist.github.com/godhin/4b036eaa7a8828b6fcca640de70f0ac1.js"></script>

- 주석을 참고하면서 이해를 돕습니다.
---

## 4. 알고리즘 및 해설
1. 이중 반복문을 통해 해당값과 다음값의 합을 리스트에 넣어준다.
2. 그 중 set()을 통해 중복을 제외한다.
3. 이후 정렬해서 출력한다.