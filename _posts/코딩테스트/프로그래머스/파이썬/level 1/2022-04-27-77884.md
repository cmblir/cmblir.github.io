...
excerpt: "프로그래머스 약수의 개수와 덧셈 문제 풀이"
...
<script src="https://gist.github.com/cmblir/8fb23fb8b067afbc9b7373c37dec68d4.js"></script>

- 주석을 참고하면서 이해를 돕습니다.
---

## 4. 알고리즘 및 해설
1. 반복문을 통해 작은수에서 큰수까지 약수의 개수들의 합을 더해주면서 식을 계산한다.
    - 이때 result라는 딕셔너리를 생성하여 해당하는 위치값에 약수를 리스트형태로 저장해준다.
2. 해당 딕셔너리를 반복문을 통해 해당 값의 약수의 합이 짝수라면 결과값에 더하고, 아니라면 빼준다.
3. 최종 결과값을 출력한다.
