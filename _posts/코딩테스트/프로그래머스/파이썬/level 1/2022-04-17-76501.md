...
<script src="https://gist.github.com/cmblir/37422cf343b80fd02e4065a23a4d7fc2.js"></script>

- 주석을 참고하면서 이해를 돕습니다.
---

## 4. 알고리즘 및 해설
1. 반복문을 통해 경우의 수를 계산해준다.
    - 해당 위치값이 True인경우 결과값에 absolutes의 같은 위치값을 더해준다.
    - 해당 위치값이 False인경우 결과값에 absolutes의 같은 위치값을 빼준다.
2. 결과값을 출력한다.