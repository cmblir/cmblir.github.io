...
<script src="https://gist.github.com/godhin/fbecaa5afcdeab9cf0f39bbd22656ec5.js"></script>
...
1. 컴프리핸션을 통해서 입력값을 공백을 기준으로 나눈 뒤 정수형으로 받은 값으로 이루어진 리스트를 만든다.
2. 이후 리스트내에서 가장 작은 값과, 가장 큰 값을 문자열로 만든다.
3. 만든 두 값을 하나로 출력해주고 위해 `join()` 함수를 이용해서 출력한다.