...
excerpt: "프로그래머스 동물의 아이디와 이름 문제 풀이"
...
<script src="https://gist.github.com/cmblir/5fcc5356d89ea603abf8d5750007199e.js"></script>
...
1. 전체 테이블 조회중 animal_id와 name을 조회한다.
2. 조회한 데이터를 order by를 통해 animal_id 기준으로 정렬하여 출력한다.