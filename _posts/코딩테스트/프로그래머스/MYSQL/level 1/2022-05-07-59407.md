...
excerpt: "프로그래머스 이름이 있는 동물의 아이디 문제 풀이"
...
<script src="https://gist.github.com/cmblir/e0a75276e27cc1fe1e4a4827058ee961.js"></script>
...
1. 전체 테이블 조회중 animal_id를 조회한다.
2. where문을 통해 이름이 공백이 아닌 경우를 찾는다.
3. 조회한 데이터를 order by를 통해 animal_id을 기준으로 정렬하여 출력한다.
