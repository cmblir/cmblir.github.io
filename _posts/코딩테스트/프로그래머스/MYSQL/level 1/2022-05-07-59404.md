...
excerpt: "프로그래머스 여러 기준으로 정렬하기 문제 풀이"
...
<script src="https://gist.github.com/cmblir/f38868b103ec947cc7c2536b3b15751d.js"></script>
...
1. 전체 테이블 조회중 animal_id와 name, datetime을 조회한다.
2. 조회한 데이터를 order by를 통해 name과 datetime을 기준으로 정렬하여 출력한다.
    - 다중정렬의 경우 앞에 오는 값 name을 기준으로 선정렬 이후 date는 후정렬이 된다.
    - 우선순위를 두고 order by를 사용해야한다.