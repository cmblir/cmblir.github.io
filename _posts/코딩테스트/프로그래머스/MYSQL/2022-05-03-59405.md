...
excerpt: "프로그래머스 상위 n개 레코드 문제 풀이"
...
<script src="https://gist.github.com/godhin/72f8e8fe16f6b63ff1830ade56ae30e6.js"></script>
...
1. 전체 테이블 조회중 name을 조회한다.
2. 조회한 데이터를 order by를 통해 datetime을 기준으로 정렬한다.
3. 정렬된 값을 limit을 통해 1개로 제한하여 출력한다.