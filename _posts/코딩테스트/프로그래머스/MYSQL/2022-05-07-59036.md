...
<script src="https://gist.github.com/godhin/9137d9f572e491a15cd74d0d24032b35.js"></script>
...
1. 전체 테이블 조회중 name과 animal_id를 조회한다.
2. where문을 통해 animal_ins의 intake_condition이 'sick'인 경우를 찾는다.
3. order by로 해당 값을 animal_id 기준으로 정렬해서 출력한다.